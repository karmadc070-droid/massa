...
### 3-2. 콘텐츠 등급 설문 (사용자가 직접 시작해야 함)
IARC 서비스 약관 동의로 간주되는 절차라 "설문지 시작" 버튼은 본인이 눌러야 합니다.

| 질문 | 답 |
|---|---|
| 이메일 | karmadc070@gmail.com |
| 카테고리 | 기타 (또는 참조/뉴스/교육) |
| 폭력·성적 콘텐츠·욕설·약물·도박·공포 | 전부 **아니요** |
| 사용자 간 상호작용 (채팅) | **예** |
| 사용자 위치 공유 | **예** |
| 개인정보 공유 | **예** (이름·주소·전화번호를 방문 제공자에게 전달) |
| 디지털 상거래 / 인앱 구매 | **아니요** (현장 후불) |
