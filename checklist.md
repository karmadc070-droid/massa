...
### 진행
- [ ] Z1. `scripts/provider_price.sql` — 칸 추가 · RPC 4개
- [ ] Z2. 예약 금액 서버 재계산 트리거
- [ ] Z3. 시험 스크립트 `scripts/test_provider_price.sql`
- [ ] Z4. index.html — priceOf() 로 가격 출처 일원화
- [ ] Z5. admin.html — 파트너 '내 가격'
- [ ] Z6. admin.html — 관리자 '가격 승인'
- [ ] Z7. 배포 (Vercel + VPS) · 브라우저 확인
