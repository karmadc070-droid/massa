...
# ── 2026-09-06 코스 확장 (마사지 11종) ──
'핫 스톤 마사지': ['Massage đá nóng', 'Hot stone massage', '热石按摩', 'ホットストーン'],
'발·다리 마사지': ['Massage chân', 'Foot & leg massage', '足腿按摩', '足・脚マッサージ'],
'머리 마사지': ['Massage đầu', 'Head massage', '头部按摩', 'ヘッドマッサージ'],
'목·어깨 마사지': ['Massage cổ vai gáy', 'Neck & shoulder massage', '颈肩按摩', '首・肩マッサージ'],
'등 마사지': ['Massage lưng', 'Back massage', '背部按摩', '背中マッサージ'],
'스포츠 마사지': ['Massage thể thao', 'Sports massage', '运动按摩', 'スポーツマッサージ'],
'오일 마사지 + 부항': ['Massage dầu + giác hơi', 'Oil massage + cupping', '精油按摩+拔罐', 'オイル＋カッピング'],
'오일 없는 마사지': ['Massage không dầu', 'Massage without oil', '无油按摩', 'オイルなし'],
'핫 스톤': ['Đá nóng', 'Hot stone', '热石', 'ホットストーン'],
'발·다리': ['Chân', 'Foot & leg', '足腿', '足・脚'],
'머리': ['Đầu', 'Head', '头部', '頭'],
'목·어깨': ['Cổ vai gáy', 'Neck & shoulder', '颈肩', '首・肩'],
'등': ['Lưng', 'Back', '背部', '背中'],
'스포츠': ['Thể thao', 'Sports', '运动', 'スポーツ'],
'오일+부항': ['Dầu + giác hơi', 'Oil + cupping', '精油+拔罐', 'オイル＋カッピング'],
'오일 없이': ['Không dầu', 'No oil', '无油', 'オイルなし'],
'따뜻한 돌로 뭉친 근육을 풀어 줍니다': ['Đá nóng làm tan cơ căng cứng.', 'Warm stones release tight muscles.', '用温热的石头放松紧绷的肌肉。', '温めた石で凝った筋肉をほぐします。'],
'오래 서 있었거나 많이 걸은 날': ['Cho ngày đứng lâu hoặc đi bộ nhiều.', 'For days spent on your feet.', '适合久站或走了很多路的日子。', '長時間立った日、たくさん歩いた日に。'],
'두피와 목까지 · 눈이 피로한 날': ['Cả da đầu và cổ · cho ngày mỏi mắt.', 'Scalp and neck · for tired eyes.', '包含头皮与颈部 · 眼睛疲劳时。', '頭皮と首まで · 目が疲れた日に。'],
'거북목과 어깨 뭉침을 집중해서': ['Tập trung vào cổ và vai bị căng.', 'Focused on neck and shoulder tension.', '集中缓解颈部与肩膀的僵硬。', '首こり・肩こりを重点的に。'],
'등과 허리 중심 · 오래 앉아 일하는 분': ['Tập trung lưng và thắt lưng · cho người ngồi nhiều.', 'Back and lower back · for desk workers.', '以背腰为主 · 适合久坐的人。', '背中と腰を中心に · 長く座って働く方へ。'],
'운동 뒤 회복 · 강한 압': ['Phục hồi sau tập · lực mạnh.', 'Post-workout recovery · firm pressure.', '运动后恢复 · 力度较强。', '運動後の回復 · 強めの圧。'],
'오일 마사지에 부항을 더합니다': ['Massage dầu kết hợp giác hơi.', 'Oil massage plus cupping.', '精油按摩加拔罐。', 'オイルマッサージにカッピングを加えます。'],
'옷 위로 · 오일이 부담스러운 분': ['Trên quần áo · nếu bạn ngại dầu.', 'Over clothing · if oil is not for you.', '隔着衣物 · 不习惯精油的人。', '服の上から · オイルが苦手な方へ。'],
'이 시간대에 가능한 코스가 없습니다.': ['Không có liệu trình cho thời lượng này.', 'No course available for this duration.', '该时长没有可选课程。', 'この時間に選べるコースがありません。'],
'코스를 다시 골라 주세요. 선택하신 시간에 맞는 코스가 없습니다.': ['Vui lòng chọn lại liệu trình. Không có liệu trình phù hợp thời lượng đã chọn.', 'Please pick a course again. None matches the duration you chose.', '请重新选择课程。所选时长没有对应课程。', 'コースを選び直してください。選んだ時間に合うコースがありません。'],
}
